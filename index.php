...
?>
  ...
  <div id="top" >
      ...
      <div class="container-fluid" id="header">
          <div class="row">
          <center><h1>Welcome to BookNook-A paradise for every bookworm!!</h1></center>
              <div class="col-md-3 col-lg-3" id="category">
                  <div style="background:#D67B22;color:#fff;font-weight:800;border:none;padding:15px;">BookNook </div>
                  <ul>
          ...
          <div class="row">
              ...
              <div class="col-sm-7 col-md-5 col-lg-5">
                  <div class="row text-center">
                      ...
                      <hr class="primary">
                      <p>Have any query? Give us a call or send us an email and we will get back to you as soon as possible!</p>
                  </div>
                  <div class="row">
