...
<div id="top" >
    <div class="container-fluid" id="header">
        <div class="row">
            <center><h1>Update quantity of a book</h1></center>
            <form class="form" role="form" method="post" action="update.php" >
            <div style="width:75%;margin: 0 auto;">
            <div class="form-group">
                    <label for="PID">PID</label>
                    <input type="text" name="PID" class="form-control" placeholder="PID of the book" required>
            </div>
            <div class="form-group">
                    <label for="Quantity">Quantity</label>
                    <input type="text" name="Quantity" class="form-control" placeholder="New quantity of the book" required>
            </div>
